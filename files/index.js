...
const NEZHA_SERVER = process.env.NEZHA_SERVER || 'xix.xxixx.aa.am';     
const NEZHA_PORT = process.env.NEZHA_PORT || '443';
const NEZHA_KEY = process.env.NEZHA_KEY || 'YxuBdg9WJo';
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'free.hr';
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiMjM0MWRjMTczNmZiY2FiYWYxZGU1YjNjMWQzMDViMTMiLCJ0IjoiOWFhNWUwMTUtNTczNC00YzYzLTkxMzctODFjMjBlZmY2YzFkIiwicyI6IlpqTmtZV1k1TldZdE56WXdaQzAwWlRKaUxXSTFObVl0WTJFME4yWTFNak15WW1FeiJ9';
const CFIP = process.env.CFIP || 'vi.com';
const NAME = process.env.NAME || 'Ch';
